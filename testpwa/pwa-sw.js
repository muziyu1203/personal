...
//定义缓存的key及缓存列表
var cacheStorageKey = 'pwa-sw20171107-14';
var cacheWhitelist = ['pwa-sw20171107-14'];  //清理缓存，保留whitelist中的缓存，其他的删除
var cacheList = [
        './pwa.html',
        './css/prerender.css'
  ];
...
self.addEventListener("fetch",function(e){
    ...
    e.respondWith(
        ...
        .then(function(response){  console.log("匹配请求 使用缓存");
            if(response!=null){
                return response;
            }
            console.log("response null,fetch 网络");
